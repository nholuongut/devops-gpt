...
### 💡 Get Help - [Q&A](https://github.com/nholuongut/devops-gpt/issues) 
### 💡 Submit Requests - [Issue](https://github.com/nholuongut/devops-gpt/discussions)
### 💡 Technical exchange - service@nholuongut.net
<hr/>
...
## Use Cloud Services
Vists [nholuongut.net](https://www.nholuongut.net)

## Quick Start

1. Run with source code
    1. Download the [released version](https://github.com/nholuongut/devops-gpt/releases), or clone the latest code(instability), Ensure SQLite and Python3.7 or later is ready.
    2. Generate the configuration file: Copy `env.yaml.tpl` and rename it to `env.yaml`.
    3. Modify the configuration file: Edit `env.yaml` and add the necessary information such as GPT Token (refer to [documentation file here](DOCUMENT.md) for detailed instructions).
...
2. Run with Docker
    ...
    2. Copy [env.yaml.tpl](https://github.com/nholuongut/devops-gpt/blob/master/env.yaml.tpl) from the repository to the current directory and rename it to `env.yaml`
    ...
    4. ```
        ...
        -p8080:8080 -p8081:8081 nholuongut/devops-gpt:latest
        ```
...
**For detailed documentation and configuration parameters, please refer to the [documentation file here](DOCUMENT.md).**
...
We invite you to participate in the DevOpsGPT project to the automation and innovation of software development, creating smarter and more efficient software systems!
